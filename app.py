...
with gr.Blocks() as demo:
    ...
    with gr.Tab("🤩 - 重磅首发：最强大的AI歌手界面"):
        ...
        gr.Markdown('''
                    ...
                    ###
                    ### 我们还为您准备了更专业的AI歌手操作界面：[滔滔AI-音乐专业版](https://kevinwang676-test-1.hf.space)
                    ### 
    ...
    with gr.Tab("🧸 - 发现更多有趣功能"):
        ...
        gr.Markdown(
            """ 
            ## 🌊 滔滔AI声音领域的三大板块：AI拟声、AI歌手、AI变声，为您提供全场景的AI声音服务 🏆
            ...
            ## 🤖 [快速声音克隆](https://kevinwang676-voice-cloning-demo.hf.space)：AI嘴替，为您在线发声
            ###
            ### 🤗 - 更多精彩，尽在滔滔AI！
